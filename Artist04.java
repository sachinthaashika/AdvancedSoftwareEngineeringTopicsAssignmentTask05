 ...
 ******************************************************************************/
public class Artist04 {
  public static void main(String[] args) {
    List<Artist> table = Arrays.asList(
	        new Artist(1, 10001, "Justin Bieber", 20),
	        ...
	        new Artist(7, 10007, "Billie Eilish", 14),
	        new Artist(8, 10008, "Ariana Grande", 22),
	        new Artist(9, 10009, "Zayn Malik", 19),
    ...
    OptionalInt max = table.stream().mapToInt(Artist::getNumberOfSongs).max();
    if (max.isPresent()) {
      System.out.printf("Highest number of Songs are %d\n", max.getAsInt());
    } else {
