...
public class Artist09 {
  public static void main(String[] args) {
		...
		System.out.println("Artists starting with S");
		table.stream().filter(artist -> artist.getArtist().contains("S")).forEach(System.out::println);
		System.out.println();
		System.out.println("Artists who had more than 15 songs in the chart");
		table.stream().filter(artist -> artist.getNumberOfSongs() > 15).forEach(System.out::println);
		}
}
