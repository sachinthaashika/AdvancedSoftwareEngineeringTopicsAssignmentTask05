...
public class Artist05 {
  public static void main(String[] args) {
    ...
    System.out.println("Several Artists have 15 Songs");
    table.stream().filter(Artist -> Artist.getNumberOfSongs() == 15)
        .forEach(System.out::println);

    System.out.println();
    System.out.println("Several Artists have 25 Songs");
    table.stream().filter(Artist -> Artist.getNumberOfSongs() == 25)
        .forEach(System.out::println);
  }
}
